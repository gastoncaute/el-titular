...
export default async function Dolar() {
  ...
  return (
    <section className="col-start-2 col-end-7 flex bg-gradient-to-b from-pageColor to-gradientColor w-max max-w-97.5rem m-auto mb-8 p-4 border border-pageColor rounded-3xl dolar_widget_container text-white text-sm">
