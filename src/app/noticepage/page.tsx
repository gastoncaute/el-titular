            ...
            <main className="grid grid-cols-3 mx-48 my-24 text-black">
                ...
                <div className="col-start-1 col-end-3 row-start-2 row-end-3 border border-black rounded-3xl  p-4">
                    ...
                    <div className="row-start-3 row-end-4 border-b border-black pb-8">
                        ...
                        <br />
                        {/* @ts-ignore */}
                        <blockquote className="twitter-tweet"><p lang="fr" dir="ltr">Messi es arte.<a href="https://t.co/O6oyErjaLI">pic.twitter.com/O6oyErjaLI</a></p>&mdash; Messismo (@Messismo10) <a href="https://twitter.com/Messismo10/status/1712994909173510367?ref_src=twsrc%5Etfw">October 14, 2023</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
